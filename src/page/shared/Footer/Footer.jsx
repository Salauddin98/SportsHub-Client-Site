      ...
      <div className="max-w-7xl mx-auto px-2 md:px-6 lg:px-8 py-5 flex flex-col justify-between space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div>
            ...
            >
              ...
              <p className="text-3xl font-bold text-gray-300">
                Lang<span className="text-orange-500">Store</span>
              </p>
            </a>
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide text-base font-bold uppercase dark:text-gray-50 text-gray-300">
              Product
            </h3>
          ...
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase dark:text-gray-50 text-gray-300 text-base font-bold">
              Company
            </h3>
            <ul className="space-y-1 text-gray-400 text-lg">
              <li>
          ...
          <div className="space-y-3">
            <h3 className="uppercase dark:text-gray-50 text-gray-300 text-base font-bold">
              Developers
            </h3>
            <ul className="space-y-1 text-gray-400 text-lg">
              <li>
          ...
          <div className="space-y-3">
            <div className="uppercase dark:text-gray-50 text-gray-300 text-base font-bold">
              Social media
            </div>
